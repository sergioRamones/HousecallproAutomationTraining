...
//	}
	...
	public void secondScript() throws InterruptedException {
		...
		startBrowser("https://opensource-demo.orangehrmlive.com/","edge");		
	...
	public void startBrowser(String url,  String  browser){
		...
		case "edge":
			...
			String pathEdgeDriver= System.getProperty("user.dir");
			System.setProperty("webdriver.edge.driver", pathEdgeDriver +"/edgeDriver/msedgedriver");
